...
const defaultFaqs = [
  ...
  { q: 'What extra benefits do TheMentR teachers receive?', a: 'TheMentR provides group insurance, mobile phone allowance, reward bonuses, banking assistance (loan eligibility, credit cards), verified badge and Experience Certificate in addition to regular pay.', category: 'Teachers' },
  { q: 'How does TheMentR ensure the quality and safety of tutors?', a: 'Every tutor undergoes multi-step verification including government ID checks, degree authentication, background screening, demo teaching assessments, reference checks and ongoing feedback monitoring.', category: 'Students' },
  { q: 'What is the fee range for tuition through TheMentR?', a: 'TheMentR offers a transparent fee structure starting at ₹1,499 per month up to ₹9,999 per month including all taxes and platform fees, with no hidden charges.', category: 'Parents' }
];
